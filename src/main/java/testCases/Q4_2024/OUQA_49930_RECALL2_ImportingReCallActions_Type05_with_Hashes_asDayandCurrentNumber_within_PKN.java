...
public class OUQA_49930_RECALL2_ImportingReCallActions_Type05_with_Hashes_asDayandCurrentNumber_within_PKN
		extends AbstractStandardBehaviour {

	String logPath = "";
	String testname = "RECALL2_ImportingReCallActions_Type05_with_#####_asDayandCurrentNumber_within_PKN";
	...
	protected void testHook() throws Throwable {
		...
		logPath = LogReports.logGeneration(testname, "ImportRecallWith_#####_asDayandCurrentNumber_within_PKN");
		ImportRecallWithFaultyFields.createImportedRecall2WithFaultyfields(RECALL_ID,
				"recall-ouqa-49930-a-minimal-data-record.json", "05", vin, faultyValue, 167, 5);
