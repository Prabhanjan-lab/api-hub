...
public class OUQA_65727_RECALL2_UNECE_REG_VWOCU3_Importing_ReCall_Actions_Type_04_Part_of_ORU_Campaign_ORU_Relevance_No_Yes extends AbstractStandardBehaviour{
	...
	String type = "Adapted";
	String logCheck = "Changed or Remains: ORU-Relevant: (J)";//need to update the logcheck
	...
	protected void testHook() throws Throwable {
		...
		logPath = LogReports.logGeneration(testname, "setTrueDST04ForVin");
		this.setLogPath(logPath);
		CreateImportedRecall.createImportedRecall(campaign, "recall-ouqa-65734-a-minimal-data-record.json");
		this.logStepPassed(logPath);
