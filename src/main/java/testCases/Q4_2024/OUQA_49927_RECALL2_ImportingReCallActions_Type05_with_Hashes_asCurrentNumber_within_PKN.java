...
public class OUQA_49927_RECALL2_ImportingReCallActions_Type05_with_Hashes_asCurrentNumber_within_PKN
		extends AbstractStandardBehaviour {

	String logPath = "";
	String testname = "RECALL2_ImportingReCallActions_Type05_with_####_asCurrentNumber_within_PKN";
	...
	protected void testHook() throws Throwable {
		...
		logPath = LogReports.logGeneration(testname, "ImportRecallWith_####_asCurrentNumber_within_PKN");
		ImportRecallWithFaultyFields.createImportedRecall2WithFaultyfields(RECALL_ID,
				"recall-ouqa-49927-a-minimal-data-record.json", "05", vin, faultyValue, 168, 4);
