...
public class packages_MIB3VW extends RegisterAndGetOAUTH{
	public static ValidatableResponse postRequestForPackages(String testname, String vin, String campaign, String criterion) throws IOException {
		String filePath = "resources/Payload_Xmls/MIB3_VW/MIB3VW_Packages.xml"; // Read the XML content from the file
	...
	public static void assertPackagesRepairDone_MIB3VW(String testname, String vin, String campaign, String criterion) throws IOException{
		ValidatableResponse repairdonepackage= packages_MIB3VW.postRequestForPackages(testname, vin, campaign, criterion);
		repairdonepackage.assertThat().statusCode(200);
	}
	
	public static void assertPackagesNoApproval_MIB3VW(String testname, String vin, String campaign, String criterion) throws IOException{
		ValidatableResponse repairdonepackage= packages_MIB3VW.postRequestForPackages(testname, vin, campaign, criterion);
	...
	public static void assertPackagesCampaignNotActive_MIB3VW(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse repairdonepackage= packages_MIB3VW.postRequestForPackages(testname, vin, campaign, criterion);
		repairdonepackage.assertThat().statusCode(400);
