...
public class packages_OCU3VW_NONUNECE_Carport extends RegisterAndGetOAUTH{
	...
	public static ValidatableResponse postRequestForPackages(String testname, String vin, String campaign, String criterion) throws IOException {
		String filePath = "resources/Payload_Xmls/OCU3_VW_Carport/OCU3_VW_Carport_Packages.xml"; // Read the XML content from the file
	...
	public static void assertPackagesRepairDone_OCU3VW_NONUNECE_Carport(String testname, String vin, String campaign, String criterion) throws IOException{
		ValidatableResponse repairdonepackage= packages_OCU3VW_NONUNECE_Carport.postRequestForPackages(testname, vin, campaign, criterion);
		repairdonepackage.assertThat().statusCode(200);
	}
	
	public static void assertPackagesNoApproval_OCU3VW_NONUNECE_Carport(String testname, String vin, String campaign, String criterion) throws IOException{
		ValidatableResponse repairdonepackage= packages_OCU3VW_NONUNECE_Carport.postRequestForPackages(testname, vin, campaign, criterion);
		repairdonepackage.assertThat().statusCode(400);
		repairdonepackage.and().assertThat().body("err.error-code", Matchers.equalToIgnoringCase("mbbc.com.vw.mbbb.onup.insufficientApproval"));
		repairdonepackage.and().assertThat().body("err.description", Matchers.equalToIgnoringCase("Vehicle has no approval for using this campaign."));
	}
	public static void assertPackagesCampaignNotActive_OCU3VW_NONUNECE_Carport(String testname, String vin, String campaign, String criterion) throws IOException{
		ValidatableResponse repairdonepackage= packages_OCU3VW_NONUNECE_Carport.postRequestForPackages(testname, vin, campaign, criterion);
		repairdonepackage.assertThat().statusCode(400);
		...
		repairdonepackage.and().assertThat().body("err.description", Matchers.equalToIgnoringCase("Campaign not active"));
	}
