...
public class packages_OCU3_VW extends RegisterAndGetOAUTH{
	...
	public static void assertPackagesRepairDone_OCU3VW(String testname, String vin, String campaign, String criterion) throws IOException{
		ValidatableResponse repairdonepackage= packages_OCU3_VW.postRequestForPackages(testname, vin, campaign, criterion);
		repairdonepackage.assertThat().statusCode(200);
	}
	
	public static void assertPackagesNoApproval_OCU3VW(String testname, String vin, String campaign, String criterion) throws IOException{
		ValidatableResponse repairdonepackage= packages_OCU3_VW.postRequestForPackages(testname, vin, campaign, criterion);
	...
	public static void assertPackagesCampaignNotActive_OCU3VW(String testname, String vin, String campaign, String criterion) throws IOException{
		ValidatableResponse repairdonepackage= packages_OCU3_VW.postRequestForPackages(testname, vin, campaign, criterion);
		repairdonepackage.assertThat().statusCode(400);
