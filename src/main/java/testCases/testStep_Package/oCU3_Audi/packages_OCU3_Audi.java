package testCases.testStep_Package.oCU3_Audi;
...
public class packages_OCU3_Audi extends RegisterAndGetOAUTH{
	...
	public static ValidatableResponse postRequestForPackages(String testname, String vin, String campaign, String criterion) throws IOException {
		String filePath = "resources/Payload_Xmls/OCU3_Audi/OCU3_Audi_Packages.xml"; // Read the XML content from the file
	...
	public static void assertPackagesRepairDone_OCU3Audi(String testname, String vin, String campaign, String criterion) throws IOException{
		ValidatableResponse repairdonepackage= packages_OCU3_Audi.postRequestForPackages(testname, vin, campaign, criterion);
		repairdonepackage.assertThat().statusCode(200);
	}
	
	public static void assertPackagesNoApproval_OCU3Audi(String testname, String vin, String campaign, String criterion) throws IOException{
		ValidatableResponse repairdonepackage= packages_OCU3_Audi.postRequestForPackages(testname, vin, campaign, criterion);
	...
	public static void assertPackagesCampaignNotActive_OCU3Audi(String testname, String vin, String campaign, String criterion) throws IOException{
		ValidatableResponse repairdonepackage= packages_OCU3_Audi.postRequestForPackages(testname, vin, campaign, criterion);
		repairdonepackage.assertThat().statusCode(400);
		repairdonepackage.and().assertThat().body("err:error", Matchers.hasItem("mbbc.com.vw.mbbb.onup.campaignnotactvie"));
