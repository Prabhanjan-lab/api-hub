package testCases.testStep_Package.mIB3_Audi;
...
public class packages_MIB3Audi extends RegisterAndGetOAUTH{
	public static ValidatableResponse postRequestForPackages(String testname, String vin, String campaign, String criterion) throws IOException {
		String filePath = "resources/Payload_Xmls/MIB3_Audi/MIB3Audi_Packages.xml"; // Read the XML content from the file
		...
		ValidatableResponse response = request.body(package_MIB3Audi).when().post("/mbb/uota_url/v1/campaign/"+campaign+"/version/"+criterion+"/packages").then().log().all();
		return response;
	}
	
	public static void assertPackagesRepairDone_MIB3Audi(String testname, String vin, String campaign, String criterion) throws IOException{
		ValidatableResponse repairdonepackage= packages_MIB3Audi.postRequestForPackages(testname, vin, campaign, criterion);
		repairdonepackage.assertThat().statusCode(200);
	}
	
	public static void assertPackagesNoApproval_MIB3Audi(String testname, String vin, String campaign, String criterion) throws IOException{
		ValidatableResponse repairdonepackage= packages_MIB3Audi.postRequestForPackages(testname, vin, campaign, criterion);
	...
	public static void assertPackagesCampaignNotActive_MIB3Audi(String testname, String vin, String campaign, String criterion) throws IOException{
		ValidatableResponse repairdonepackage= packages_MIB3Audi.postRequestForPackages(testname,  vin, campaign, criterion);
		repairdonepackage.assertThat().statusCode(400);
