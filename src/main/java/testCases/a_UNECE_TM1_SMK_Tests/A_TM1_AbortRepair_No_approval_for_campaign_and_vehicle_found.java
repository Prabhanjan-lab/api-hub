...
@Tag("Demo_ECE")
@Tag("Approval_ECE")
public class A_TM1_AbortRepair_No_approval_for_campaign_and_vehicle_found extends AbstractStandardBehaviour {
	String logPath = "";
	...
	protected void setUp() throws Throwable {
		...
		try {
			...
			this.initTestContainer(1); // test has two test step
		}
	}
