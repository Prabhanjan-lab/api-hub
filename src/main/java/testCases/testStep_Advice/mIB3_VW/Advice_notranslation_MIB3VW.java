...
public class Advice_notranslation_MIB3VW extends RegisterAndGetOAUTH {
	...
	public static void assertAdviceRepairNecessary_MIB3VW(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice = Advice_notranslation_MIB3VW.postRequestForAdvice(testname, vin, campaign, criterion);
