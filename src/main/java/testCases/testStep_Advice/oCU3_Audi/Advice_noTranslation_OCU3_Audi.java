...
public class Advice_noTranslation_OCU3_Audi extends RegisterAndGetOAUTH{
	...
	public static ValidatableResponse postRequestForAdvice(String testname, String vin, String campaign, String criterion) throws IOException {
		...
		request.header("Authorization", "Bearer " + OAuthToken)
				...
				.queryParam("lang", "fr_FR").queryParam("vc", PutVCHash).queryParam("timestamp", "2016-04-28T09:00:00Z");
	...
	public static void assertAdviceAbortRepair_OCU3_Audi(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice = Advice_noTranslation_OCU3_Audi.postRequestForAdvice(testname, vin, campaign, criterion);
