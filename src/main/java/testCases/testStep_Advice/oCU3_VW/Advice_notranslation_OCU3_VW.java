...
public class Advice_notranslation_OCU3_VW extends RegisterAndGetOAUTH{
	...
	public static void assertAdviceAbortRepair_OCU3_VW(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice= Advice_notranslation_OCU3_VW.postRequestForAdvice(testname, vin, campaign, criterion );
	...
	public static void assertAdviceRepairNecessary_OCU3VW(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice= Advice_notranslation_OCU3_VW.postRequestForAdvice(testname, vin, campaign, criterion );
		advice.assertThat().statusCode(200);
