...
public class Advice_OCU3VW_NONUNECE_Carport extends RegisterAndGetOAUTH{
	...
	public static void assertAdviceAbortRepair_OCU3VW_NONUNECE_Carport(String testname, String putVC, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice= Advice_OCU3VW_NONUNECE_Carport.postRequestForAdvice(testname, putVC, vin, campaign, criterion);
	...
	public static void assertAdviceIncorrectCampaign_OCU3VW_NONUNECE_Carport(String testname, String putVC, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice= Advice_OCU3VW_NONUNECE_Carport.postRequestForAdvice(testname, putVC, vin, campaign, criterion);
		advice.assertThat().statusCode(200);
		advice.and().body("repairAdvice.adviceCode", Matchers.equalTo("ABORT_REPAIR"));
	...
	public static void assertAdviceRepairNecessary_OCU3VW_NONUNECE_Carport(String testname, String putVC, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice= Advice_OCU3VW_NONUNECE_Carport.postRequestForAdvice(testname, putVC, vin, campaign, criterion);
		advice.assertThat().statusCode(200);
		advice.and().body("repairAdvice.adviceCode", Matchers.equalTo("REPAIR_NECESSARY"));
	}
	
	public static void assertAdviceRepairComplete_OCU3VW_NONUNECE_Carport(String testname, String putVC, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice= Advice_OCU3VW_NONUNECE_Carport.postRequestForAdvice(testname, putVC, vin, campaign, criterion);
		advice.assertThat().statusCode(200);
		advice.and().body("repairAdvice.adviceCode", Matchers.equalTo("REPAIR_COMPLETE"));
	}
	
	public static void assertAdviceAbortRepairImplausible_OCU3VW_NONUNECE_Carport(String testname, String putVC, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice= Advice_OCU3VW_NONUNECE_Carport.postRequestForAdvice(testname, putVC, vin, campaign, criterion);
		advice.assertThat().statusCode(200);
		advice.and().body("repairAdvice.adviceCode", Matchers.equalTo("ABORT_REPAIR"));
	...
	public static void assertAdviceWithUnknownVC_OCU3VW_NONUNECE_Carport(String testname, String putVC, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice= Advice_OCU3VW_NONUNECE_Carport.postRequestForAdvice(testname, putVC, vin, campaign, criterion);
