...
public class Advice_OCU3_VW extends RegisterAndGetOAUTH{
	...
	public static void assertAdviceAbortRepair_OCU3_VW(String testname, String putVC, String vin, String campaign, String criterion) throws IOException {
	...
	public static void assertAdviceIncorrectCampaign_OCU3_VW(String testname, String putVC, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice= Advice_OCU3_VW.postRequestForAdvice(testname, putVC, vin, campaign, criterion);
		advice.assertThat().statusCode(200);
		advice.and().body("repairAdvice.adviceCode", Matchers.equalTo("ABORT_REPAIR"));
	...
	public static void assertAdviceRepairNecessary_OCU3VW(String testname, String putVC, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice= Advice_OCU3_VW.postRequestForAdvice(testname, putVC, vin, campaign, criterion);
		advice.assertThat().statusCode(200);
	...
	public static void assertAdviceRepairComplete_OCU3VW(String testname, String putVC, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice= Advice_OCU3_VW.postRequestForAdvice(testname, putVC, vin, campaign, criterion);
		advice.assertThat().statusCode(200);
	...
	public static void assertAdviceAbortRepairImplausible_OCU3_VW(String testname, String putVC, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice= Advice_OCU3_VW.postRequestForAdvice(testname, putVC, vin, campaign, criterion);
		advice.assertThat().statusCode(200);
		advice.and().body("repairAdvice.adviceCode", Matchers.equalTo("ABORT_REPAIR"));
	...
	public static void assertAdviceWithUnknownVC_OCU3_VW(String testname, String putVC, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice= Advice_OCU3_VW.postRequestForAdvice(testname, putVC, vin, campaign, criterion);
