...
public class Advice_notranslation_OCU3_VW_NONUNECE extends RegisterAndGetOAUTH{
	...
	public static void assertAdviceAbortRepair_OCU3_VW_NONUNECE(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice= Advice_notranslation_OCU3_VW_NONUNECE.postRequestForAdvice(testname, vin, campaign, criterion);
