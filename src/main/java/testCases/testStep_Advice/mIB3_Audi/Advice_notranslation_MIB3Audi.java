...
public class Advice_notranslation_MIB3Audi extends RegisterAndGetOAUTH {
	...
	public static void assertAdviceAbortRepair_MIB3Audi(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse advice = Advice_notranslation_MIB3Audi.postRequestForAdvice(testname, vin, campaign, criterion);
