...
public class A_OUQA_64865_REG_L_S_Massnotification_TM1_MQTT_VW extends AbstractStandardBehaviour{

	String logPath = "";
	String testname = "Massnotification_TM1_MQTT_VW";
	...
	protected void testHook() throws Throwable {
		...
		CreateManualRecall.assertCreateManualRecall(testname, TestVariables.OUQA_64865_filePath,recallID);
