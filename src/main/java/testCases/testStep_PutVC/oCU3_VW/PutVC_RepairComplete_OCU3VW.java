...
public class PutVC_RepairComplete_OCU3VW extends RegisterAndGetOAUTH{
	
	public static ValidatableResponse putResquestForPutVc(String testname, String vin) throws IOException{
		
		String filePath = "resources/Payload_Xmls/OCU3_VW/OCU3_VW_PUTVC_RepairComplete.xml"; // Read the XML content from the file
	...
	public static void assertPutVC_OCU3VW(String testname, String vin) throws IOException {
		ValidatableResponse putvc= PutVC_RepairComplete_OCU3VW.putResquestForPutVc(testname, vin);
