...
public class PutVC_RepairNecessary_OCU3VW extends RegisterAndGetOAUTH{
	...
	public static void assertPutVC_OCU3VW(String testname, String vin) throws IOException {
		ValidatableResponse putvc= PutVC_RepairNecessary_OCU3VW.putResquestForPutVc(testname, vin);
