...
public class PutVC_RepairComplete_OCU3VW_NONUNECE extends RegisterAndGetOAUTH{
	
	public static ValidatableResponse putResquestForPutVc(String testname, String vin) throws IOException{
		
		String filePath = "resources/Payload_Xmls/OCU3_VW_NONUNECE/OCU3_VW_NONUNECE_PUTVC_RepairComplete.xml"; // Read the XML content from the file
	...
	public static void assertPutVC_OCU3VW_NONUNECE(String testname, String vin) throws IOException {
		ValidatableResponse putvc= PutVC_RepairComplete_OCU3VW_NONUNECE.putResquestForPutVc(testname, vin);
