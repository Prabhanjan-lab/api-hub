...
public class PutVC_RepairNecessary_OCU3VW_NONUNECE_Carport extends RegisterAndGetOAUTH{
public static ValidatableResponse putResquestForPutVc(String testname, String vin) throws IOException{
	
	String filePath = "resources/Payload_Xmls/OCU3_VW_Carport/OCU3_VW_NONUNECE_Carport_PUTVC_RepairNecessary.xml"; // Read the XML content from the file
...
public static void assertPutVC_OCU3VW_NONUNECE_Carport(String testname, String vin) throws IOException {
	ValidatableResponse putvc= PutVC_RepairNecessary_OCU3VW_NONUNECE_Carport.putResquestForPutVc(testname, vin);
