...
public class PutVC_RepairNecessary_OCU3VW_NONUNECE extends RegisterAndGetOAUTH{
public static ValidatableResponse putResquestForPutVc(String testname, String vin) throws IOException{
	
	String filePath = "resources/Payload_Xmls/OCU3_VW_NONUNECE/OCU3_VW_NONUNECE_PUTVC_RepairNecessary.xml"; // Read the XML content from the file
	...
	request.header("Authorization","Bearer " + OAuthToken)
		...
		.header("Content-Type","application/vnd.vwg.mbb.onlineUpdateVehicleConfiguration_v1_0_0+xml")
		.header("X-Vin",vin);
...
public static void assertPutVC_OCU3VW_NONUNECE(String testname, String vin) throws IOException {
	ValidatableResponse putvc= PutVC_RepairNecessary_OCU3VW_NONUNECE.putResquestForPutVc(testname, vin);
