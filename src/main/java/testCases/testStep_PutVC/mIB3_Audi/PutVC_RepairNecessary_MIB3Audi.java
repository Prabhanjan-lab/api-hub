...
public class PutVC_RepairNecessary_MIB3Audi extends RegisterAndGetOAUTH{
	public static ValidatableResponse putResquestForPutVc(String testname, String vin) throws IOException{
		
		String filePath = "resources/Payload_Xmls/MIB3_Audi/MIB3Audi_PUTVC_RepairNecessary.xml"; // Read the XML content from the file
	...
	public static void assertPutVC_MIB3Audi(String testname, String vin) throws IOException {
		ValidatableResponse putvc= PutVC_RepairNecessary_MIB3Audi.putResquestForPutVc(testname, vin);
