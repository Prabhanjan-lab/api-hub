...
public class PutVC_RepairNecessary_OCU3Audi extends RegisterAndGetOAUTH{
	
	public static ValidatableResponse putResquestForPutVc(String testname, String vin) throws IOException{
		
		String filePath = "resources/Payload_Xmls/OCU3_Audi/OCU3_Audi_PUTVC_RepairNecessary.xml"; // Read the XML content from the file
	...
	public static void assertPutVC_OCU3Audi(String testname, String vin) throws IOException {
		ValidatableResponse putvc= PutVC_RepairNecessary_OCU3Audi.putResquestForPutVc(testname, vin);
