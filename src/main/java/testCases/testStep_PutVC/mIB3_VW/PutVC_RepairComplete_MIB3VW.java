...
public class PutVC_RepairComplete_MIB3VW extends RegisterAndGetOAUTH{
	public static ValidatableResponse putResquestForPutVc(String testname, String vin) throws IOException{
		
		String filePath = "resources/Payload_Xmls/MIB3_VW/MIB3VW_PUTVC_RepairComplete.xml"; // Read the XML content from the file
	...
	public static void assertPutVC_MIB3VW(String testname, String vin) throws IOException {
		ValidatableResponse putvc= PutVC_RepairComplete_MIB3VW.putResquestForPutVc(testname, vin);
