...
public class PutVC_RepairNecessary_MIB3VW_ODP extends RegisterAndGetOAUTH{
	public static ValidatableResponse putResquestForPutVc(String testname, String vin) throws IOException{
		
		String filePath = "resources/Payload_Xmls/MIB3_VW_ODP/MIB3VW_ODP_PUTVC_RepairNecessary.xml"; // Read the XML content from the file
	...
	public static void assertPutVC_MIB3VW_ODP(String testname, String vin) throws IOException {
		ValidatableResponse putvc= PutVC_RepairNecessary_MIB3VW_ODP.putResquestForPutVc(testname, vin);
