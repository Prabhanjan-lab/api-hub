...
public class OUQA_60474_No_Documentation_is_done_with_ImportedRecallandManualS42 extends AbstractStandardBehaviour {
	String logPath = "";
	String testname = "No_Documentation_is_done_with_ImportedRecallandManualS42";
	...
	protected void testHook() throws Throwable {
		...
		logPath = LogReports.logGeneration(testname, "CheckingDocumentation");
		this.setLogPath(logPath);
