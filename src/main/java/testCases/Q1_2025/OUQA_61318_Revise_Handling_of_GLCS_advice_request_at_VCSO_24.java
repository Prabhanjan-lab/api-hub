...
import testCases.reusable_TestSteps.GetVehicleCampaignActivity;
...
public class OUQA_61318_Revise_Handling_of_GLCS_advice_request_at_VCSO_24 extends AbstractStandardBehaviour{
	...
	protected void setUp() throws Throwable {
		...
		try {
			...
			this.initTestContainer(16); // test has twelve test step
		}
	}
	...
	protected void testHook() throws Throwable {
		...
		logPath = LogReports.logGeneration(testname, "Assert_VCA_CustomerNotified");
		this.setLogPath(logPath);
		GetVehicleCampaignActivity.assertVCA(testname);
		this.logStepPassed(logPath);
