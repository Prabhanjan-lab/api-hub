...
@Tag("Approval_ECE")
@Tag("23Q3")
public class OUQA_54596_VW_MIB3_Trigger_CancelUpdateJobs_AEU1_and_VCSO_19_new extends AbstractStandardBehaviour {
	String logPath = "";
	String testname = "VWMIB3_CancelUpdateJobs_AEU1_and_VCSO_19_new";
	...
	protected void testHook() throws Throwable {
		...
		logPath = LogReports.logGeneration(testname, "VCSOStatus 38");
		this.setLogPath(logPath);
