...
public class StatusCode8_OCU3_Audi extends RegisterAndGetOAUTH{
	...
	public static void assertStatusCode_OCU3Audi(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse status=StatusCode8_OCU3_Audi.postRequestForStatusCode(testname, vin, campaign, criterion);
