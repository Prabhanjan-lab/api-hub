...
public class StatusCode4_OCU3_Audi extends RegisterAndGetOAUTH{
	...
	public static void assertStatusCode_OCU3Audi(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse status=StatusCode4_OCU3_Audi.postRequestForStatusCode(testname, vin, campaign, criterion);
