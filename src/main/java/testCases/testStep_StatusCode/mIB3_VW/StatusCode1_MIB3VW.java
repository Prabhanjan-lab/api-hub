...
public class StatusCode1_MIB3VW extends RegisterAndGetOAUTH{
	...
	public static void assertStatusCode_MIB3VW(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse status=StatusCode1_MIB3VW.postRequestForStatusCode(testname, vin, campaign, criterion);
