...
public class StatusCode1_MIB3VW_ODP extends RegisterAndGetOAUTH{
	...
	public static void assertStatusCode_MIB3VW_ODP(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse status=StatusCode1_MIB3VW_ODP.postRequestForStatusCode(testname, vin, campaign, criterion);
