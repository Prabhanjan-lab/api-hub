...
public class StatusCode3_OCU3_VW_NONUNECE extends RegisterAndGetOAUTH{
	public static ValidatableResponse postRequestForStatusCode(String testname, String vin, String campaign, String criterion) throws IOException {
		String filePath = "resources/Payload_Xmls/StatusCode3_NONUNECE.xml"; // Read the XML content from the file
	...
	public static void assertStatusCode_OCU3VW_NONUNECE(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse status=StatusCode3_OCU3_VW_NONUNECE.postRequestForStatusCode(testname, vin, campaign, criterion);
