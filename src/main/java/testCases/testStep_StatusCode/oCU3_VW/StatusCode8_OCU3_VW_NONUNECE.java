...
public class StatusCode8_OCU3_VW_NONUNECE extends RegisterAndGetOAUTH{
	...
	public static void assertStatusCode_OCU3VW_NONUNECE(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse status=StatusCode8_OCU3_VW_NONUNECE.postRequestForStatusCode(testname, vin, campaign, criterion);
