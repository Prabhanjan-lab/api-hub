...
public class StatusCode6_OCU3_VW extends RegisterAndGetOAUTH{
	...
	public static void assertStatusCode_OCU3VW(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse status=StatusCode6_OCU3_VW.postRequestForStatusCode(testname, vin, campaign, criterion);
