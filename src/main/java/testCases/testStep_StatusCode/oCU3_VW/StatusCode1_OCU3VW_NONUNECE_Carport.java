...
public class StatusCode1_OCU3VW_NONUNECE_Carport extends RegisterAndGetOAUTH {
	...
	public static void assertStatusCode_OCU3VW_NONUNECE_Carport(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse status=StatusCode1_OCU3VW_NONUNECE_Carport.postRequestForStatusCode(testname, vin, campaign, criterion);
