...
public class StatusCode5_OCU3_VW extends RegisterAndGetOAUTH{
	...
	public static ValidatableResponse postRequestForStatusCode(String testname, String vin, String campaign, String criterion) throws IOException {
		String filePath = "resources/Payload_Xmls/StatusCode5.xml"; // Read the XML content from the file
	...
	public static void assertStatusCode_OCU3VW(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse status=StatusCode5_OCU3_VW.postRequestForStatusCode(testname, vin, campaign, criterion);
