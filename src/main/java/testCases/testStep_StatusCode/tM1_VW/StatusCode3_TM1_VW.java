...
public class StatusCode3_TM1_VW extends RegisterAndGetOAUTH{
	...
	public static void assertStatusCode_TM1VW(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse status=StatusCode3_TM1_VW.postRequestForStatusCode(testname, vin, campaign, criterion);
