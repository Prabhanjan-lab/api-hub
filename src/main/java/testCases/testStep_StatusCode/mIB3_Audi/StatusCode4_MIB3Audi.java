...
public class StatusCode4_MIB3Audi extends RegisterAndGetOAUTH{
	...
	public static ValidatableResponse postRequestForStatusCode(String testname, String vin, String campaign, String criterion) throws IOException {
		String filePath = "resources/Payload_Xmls/StatusCode4.xml"; // Read the XML content from the file
	...
	public static void assertStatusCode_MIB3Audi(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse status=StatusCode4_MIB3Audi.postRequestForStatusCode(testname, vin, campaign, criterion);
