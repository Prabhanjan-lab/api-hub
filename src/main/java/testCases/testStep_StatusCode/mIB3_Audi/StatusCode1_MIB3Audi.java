...
public class StatusCode1_MIB3Audi extends RegisterAndGetOAUTH{
	...
	public static void assertStatusCode_MIB3Audi(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse status=StatusCode1_MIB3Audi.postRequestForStatusCode(testname, vin, campaign, criterion);
