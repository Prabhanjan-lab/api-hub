...
import testCases.testStep_StatusCode.mIB3_VW.StatusCode4_MIB3VW_ODP;
import testCases.testStep_StatusCode.mIB3_VW.StatusCode7_MIB3VW_ODP;
import testCases.testStep_StatusCode.mIB3_VW.StatusCode8_MIB3VW_ODP;
...
@Tag("Approval_ECE")
@Tag("24Q2")
public class OUQA_17804_LS_03_Passat_MIB3_RepairDone extends AbstractStandardBehaviour {
	String logPath = "";
	String testname = "Passat_MIB3_RepairDone";
	...
	protected void testHook() throws Throwable {
		...
		this.setLogPath(logPath);
		packages_MIB3VW_ODP.assertPackagesRepairDone_MIB3VW_ODP(testname, vin, campaign, criterion);
		this.logStepPassed(logPath);
		...
		this.setLogPath(logPath);
		StatusCode4_MIB3VW_ODP.assertStatusCode_MIB3VW_ODP(testname, vin, campaign, criterion);
		this.logStepPassed(logPath);

		logPath = LogReports.logGeneration(testname, "StatusCode7");
		this.setLogPath(logPath);
		StatusCode7_MIB3VW_ODP.assertStatusCode_MIB3VW_ODP(testname, vin, campaign, criterion);
		this.logStepPassed(logPath);

		logPath = LogReports.logGeneration(testname, "StatusCode8");
		this.setLogPath(logPath);
		StatusCode8_MIB3VW_ODP.assertStatusCode_MIB3VW_ODP(testname, vin, campaign, criterion);
		this.logStepPassed(logPath);
