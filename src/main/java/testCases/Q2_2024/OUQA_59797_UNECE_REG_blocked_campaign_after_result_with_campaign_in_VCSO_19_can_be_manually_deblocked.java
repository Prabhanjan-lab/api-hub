...
import testCases.testStep_ResultCode.oCU3_VW.ResultCode4_17_OCU3_VW;
...
public class OUQA_59797_UNECE_REG_blocked_campaign_after_result_with_campaign_in_VCSO_19_can_be_manually_deblocked
		extends AbstractStandardBehaviour {

	String logPath = "";
	String testname = "VWOCU3_UNECE_REG_blocked_campaign_after_result_with_campaign_in_VCSO_19_can_be_manually_deblocked";
	...
	protected void testHook() throws Throwable {
		...
		logPath = LogReports.logGeneration(testname, "ResultCode4-17");
		this.setLogPath(logPath);
		ResultCode4_17_OCU3_VW.assertResultCode_OCU3VW(testname, TestVariables.PutVCHash, vin, campaign, criterion);
		this.logStepPassed(logPath);
		...
		logPath = LogReports.logGeneration(testname, "UnBlockVehicle");
		this.setLogPath(logPath);
		Unblock_Vehicle.Unblock_BlockedVin(testname, vin, campaign, criterion);
		this.logStepPassed(logPath);
