...
public class OUQA_17807_LS_06_Passat_MIB3_AbortRepair_IncorrectCampaignProgress extends AbstractStandardBehaviour {
	String logPath = "";
	...
	protected void setUp() throws Throwable {
		...
		try {
			...
			initTestContainer(7); // test has seven steps
		}
	}
	...
	protected void testHook() throws Throwable {
		...
		this.setLogPath(logPath);
		Advice_MIB3VW_ODP.assertAdviceIncorrectCampaign_MIB3VW_ODP(testname, TestVariables.PutVCHash, vin, campaign, criterion);
		this.logStepPassed(logPath);
