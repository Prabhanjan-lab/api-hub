...
public class OUQA_59782_NON_UNECE_01_VW_OCU3_AbortRepair_No_batch_found_for_vehicle extends AbstractStandardBehaviour{

	String logPath = "";
	String testname = "NON_UNECE_VWOCU3_NoBatch";
	...
	protected void setUp() throws Throwable {
		...
		try {
			...
			this.initTestContainer(5); // test has five test step
		}
	}
