...
public class C_UNECE_REG_Using_several_Batches_Automatic_approval_of_batches_has_to_work
extends AbstractStandardBehaviour {
	...
	protected void testHook() throws Throwable {
		...
		if (ScheduledQueue.assertCampaignInScheduledQueue(testname, vin2)) {
			...
			List<String> scheduledCampaignsCriterionList = ScheduledQueue.getScheduledCampaignsCriterion(testname, vin2);
