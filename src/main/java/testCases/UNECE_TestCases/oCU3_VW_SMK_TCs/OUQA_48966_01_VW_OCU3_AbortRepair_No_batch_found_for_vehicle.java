...
public class OUQA_48966_01_VW_OCU3_AbortRepair_No_batch_found_for_vehicle extends AbstractStandardBehaviour {
	String logPath = "";
	...
	protected void testHook() throws Throwable {
		...
		this.setLogPath(logPath);
		Advice_OCU3_VW.assertAdviceAbortRepair_OCU3_VW(testname, TestVariables.PutVCHash, vin, campaign, criterion);
		this.logStepPassed(logPath);
