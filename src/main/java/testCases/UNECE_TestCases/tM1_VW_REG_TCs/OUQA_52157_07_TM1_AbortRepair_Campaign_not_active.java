...
public class OUQA_52157_07_TM1_AbortRepair_Campaign_not_active extends AbstractStandardBehaviour {
	String logPath = "";
	String testname = "TM1VW_CampaignNotActive";
	...
	protected void testHook() throws Throwable {
		...
		this.setLogPath(logPath);
		packages_TM1_VW.assertPackagesCampaignNotActive_TM1VW(testname, vin, campaign, criterion);
		this.logStepPassed(logPath);
