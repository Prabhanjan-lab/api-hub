...
public class OUQA_52156_06_TM1_AbortRepair_Incorrect_Campaign_Progress extends AbstractStandardBehaviour {
	String logPath = "";
	...
	protected void testHook() throws Throwable {
		...
		this.setLogPath(logPath);
		Advice_TM1_VW.assertAdviceIncorrectCampaign_TM1_VW(testname, TestVariables.PutVCHash, vin, campaign, criterion);
		this.logStepPassed(logPath);

		logPath = LogReports.logGeneration(testname, "Package");
		this.setLogPath(logPath);
		packages_TM1_VW.assertPackagesNoApproval_TM1VW(testname, vin, campaign, criterion);
		this.logStepPassed(logPath);
