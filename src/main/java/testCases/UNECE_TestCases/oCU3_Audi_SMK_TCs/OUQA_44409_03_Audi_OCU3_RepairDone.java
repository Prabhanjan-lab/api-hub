...
import testCases.testStep_ResultCode.oCU3_Audi.ResultCode1_OCU3_Audi;
import testCases.testStep_StatusCode.oCU3_Audi.StatusCode1_OCU3_Audi;
import testCases.testStep_StatusCode.oCU3_Audi.StatusCode3_OCU3_Audi;
import testCases.testStep_StatusCode.oCU3_Audi.StatusCode4_OCU3_Audi;
import testCases.testStep_StatusCode.oCU3_Audi.StatusCode7_OCU3_Audi;
import testCases.testStep_StatusCode.oCU3_Audi.StatusCode8_OCU3_Audi;
import testCases.utils.LogReports;
import testCases.utils.TestVariables;

public class OUQA_44409_03_Audi_OCU3_RepairDone extends TestVariables {
	String testname = "OCU3Audi_RepairDone";
	...
	@Test
	// TODO: test format?
	public void OCU3AudiRepairDone() throws Exception {
		...
		Advice_OCU3_Audi.assertAdviceRepairNecessary_OCU3Audi(testname, PutVCHash, vin, campaign, criterion);
		...
		packages_OCU3_Audi.assertPackagesRepairDone_OCU3Audi(testname, vin, campaign, criterion);

		LogReports.logGeneration(testname, "VCSOStatus19");
		ActiveQueueVCSOStatus.assertActiveQueue(testname, vin, campaign, "19");

		LogReports.logGeneration(testname, "StatusCode3");
		StatusCode3_OCU3_Audi.assertStatusCode_OCU3Audi(testname, vin, campaign, criterion);

		LogReports.logGeneration(testname, "VCSOStatus20");
		ActiveQueueVCSOStatus.assertActiveQueue(testname, vin, campaign, "20");

		LogReports.logGeneration(testname, "StatusCode4");
		StatusCode4_OCU3_Audi.assertStatusCode_OCU3Audi(testname, vin, campaign, criterion);

		LogReports.logGeneration(testname, "StatusCode7");
		StatusCode7_OCU3_Audi.assertStatusCode_OCU3Audi(testname, vin, campaign, criterion);

		LogReports.logGeneration(testname, "StatusCode8");
		StatusCode8_OCU3_Audi.assertStatusCode_OCU3Audi(testname, vin, campaign, criterion);

		LogReports.logGeneration(testname, "ResultCode1");
		ResultCode1_OCU3_Audi.assertResultCode_OCU3Audi(testname, PutVCHash, vin, campaign, criterion);
