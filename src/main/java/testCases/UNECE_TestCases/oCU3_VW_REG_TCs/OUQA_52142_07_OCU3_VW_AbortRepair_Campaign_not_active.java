...
public class OUQA_52142_07_OCU3_VW_AbortRepair_Campaign_not_active extends AbstractStandardBehaviour {
	String logPath = "";
	...
	protected void testHook() throws Throwable {
		...
		this.setLogPath(logPath);
		packages_OCU3_VW.assertPackagesCampaignNotActive_OCU3VW(testname, vin, campaign, criterion);
		this.logStepPassed(logPath);
