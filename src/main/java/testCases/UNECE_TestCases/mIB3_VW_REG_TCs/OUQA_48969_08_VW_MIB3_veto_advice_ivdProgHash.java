...
@Tag("Approval_ECE")
@Tag("23Q3")
public class OUQA_48969_08_VW_MIB3_veto_advice_ivdProgHash extends AbstractStandardBehaviour {
	String logPath = "";
	String testname = "MIB3VW_VetoAdvice";
	...
	protected void setUp() throws Throwable {
		...
		try {
			...
			this.initTestContainer(7); // test has five test step
		}
	}
