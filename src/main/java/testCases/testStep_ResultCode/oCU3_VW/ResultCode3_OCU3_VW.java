...
public class ResultCode3_OCU3_VW extends RegisterAndGetOAUTH{
	...
	public static void assertResultCode3_OCU3VW(String testname, String VC, String vin, String campaign, String criterion ) throws IOException {
		ValidatableResponse result= ResultCode3_OCU3_VW.postRequestForResultCode(testname, VC, vin, campaign, criterion);
		result.assertThat().statusCode(404);
		result.and().assertThat().body("error-code", Matchers.hasItem("mbbc.com.vw.mbbb.onup.unknownVC"));
		result.and().assertThat().body("description", Matchers.hasItem("No such vehicle configuration found, a VC has to be transmitted first."));
	}
}
