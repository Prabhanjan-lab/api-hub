...
public class ResultCode4_17_OCU3_VW extends RegisterAndGetOAUTH{
	...
	public static ValidatableResponse postRequestForResultCode(String testname, String VC, String vin, String campaign, String criterion ) throws IOException {
		String filePath = "resources/Payload_Xmls/ResultCode4-17.xml"; // Read the XML content from the file
	...
	public static void assertResultCode_OCU3VW(String testname, String VC, String vin, String campaign, String criterion ) throws IOException {
		ValidatableResponse result= ResultCode4_17_OCU3_VW.postRequestForResultCode(testname, VC, vin, campaign, criterion);
