...
public class ResultCode4_22_OCU3_VW extends RegisterAndGetOAUTH{
	...
	public static void assertResultCode_OCU3VW(String testname, String VC, String vin, String campaign, String criterion ) throws IOException {
		ValidatableResponse result= ResultCode4_22_OCU3_VW.postRequestForResultCode(testname, VC, vin, campaign, criterion);
