...
public class ResultCode4_13_MIB3VW extends RegisterAndGetOAUTH{
	...
	public static void assertResultCode_MIB3VW(String testname, String VC, String vin, String campaign, String criterion ) throws IOException {
		ValidatableResponse result= ResultCode4_13_MIB3VW.postRequestForResultCode(testname, VC, vin, campaign, criterion);
