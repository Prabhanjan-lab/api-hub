...
public class ResultCode2_MIB3VW extends RegisterAndGetOAUTH{
	...
	public static void assertResultCode_MIB3VW(String testname, String VC, String vin, String campaign, String criterion ) throws IOException {
		ValidatableResponse result= ResultCode2_MIB3VW.postRequestForResultCode(testname, VC, vin, campaign, criterion);
