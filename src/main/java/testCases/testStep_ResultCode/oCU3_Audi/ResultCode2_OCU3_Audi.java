...
public class ResultCode2_OCU3_Audi extends RegisterAndGetOAUTH{
	...
	public static void assertResultCode_OCU3Audi(String testname, String VC, String vin, String campaign, String criterion ) throws IOException {
		ValidatableResponse result = ResultCode2_OCU3_Audi.postRequestForResultCode(testname, VC, vin, campaign, criterion);
