...
public class ResultCode4_13_MIB3Audi extends RegisterAndGetOAUTH{
	...
	public static void assertResultCode_MIB3Audi(String testname, String putVC, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse result= ResultCode4_13_MIB3Audi.postRequestForResultCode(testname, putVC, vin, campaign, criterion);
