...
public class ResultCode2_TM1_VW extends RegisterAndGetOAUTH{
	...
	public static void assertResultCode_TM1VW(String testname, String VC, String vin, String campaign, String criterion ) throws IOException {
		ValidatableResponse result= ResultCode2_TM1_VW.postRequestForResultCode(testname, VC, vin, campaign, criterion);
