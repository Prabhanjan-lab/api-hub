...
public class UploadInstallbase_MIB3_VW_MQTT extends RegisterAndGetOAUTH {
	
	public static ValidatableResponse putRequestForUploadIB() throws IOException {
		String filePath = "resources/Payload_Xmls/MIB3_VW/MIB3VW_MQTT_Installbase.xml"; // Read the XML content from the file
	...
	public static void assertInstallbase_MIB3VW_MQTT() throws IOException {	
		ValidatableResponse ib= UploadInstallbase_MIB3_VW_MQTT.putRequestForUploadIB();
