package testCases.c_UNECE_VW_OCU3_REG_Tests;
...
public class C_VW_OCU3_VetoAdvice extends AbstractStandardBehaviour {
	String logPath = "";
	...
	protected void setUp() throws Throwable {
		...
		try {
			...
			this.initTestContainer(1); // test has eighteen test step
		}
	}
