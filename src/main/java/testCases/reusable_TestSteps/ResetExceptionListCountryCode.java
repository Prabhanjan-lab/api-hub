...
public class ResetExceptionListCountryCode extends JWT {
	public static ValidatableResponse upadateExceptionListCountryCode(String testname) throws Exception {
		...
		if (env.equalsIgnoreCase("DEMO_ECE")) {
			String filePath = "resources/Payload_Jsons/Demo_ResetExceptionListCountryCode.json";
			payload = new String(Files.readAllBytes(Paths.get(filePath)));

		} else if (env.equalsIgnoreCase("APPROVAL_ECE")) {
			String filePath = "resources/Payload_Jsons/Approval_ResetExceptionListCountryCode.json";
			payload = new String(Files.readAllBytes(Paths.get(filePath)));
		} else {
	...
	public static void assertUpdateExceptionListCountryCode(String testname) throws Exception {
		ValidatableResponse response = ResetExceptionListCountryCode.upadateExceptionListCountryCode(testname);
