package testCases.c_UNECE_VW_MIB3_SMK_Tests;
...
@Tag("Demo_ECE")
@Tag("Approval_ECE")
public class C_VW_MIB3_RepairComplete extends AbstractStandardBehaviour {

	String logPath = "";
	String testname = "MIB3VW_RepairComplete";
