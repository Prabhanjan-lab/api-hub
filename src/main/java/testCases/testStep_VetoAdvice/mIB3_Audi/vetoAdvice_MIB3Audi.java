package testCases.testStep_VetoAdvice.mIB3_Audi;
...
public class vetoAdvice_MIB3Audi extends RegisterAndGetOAUTH{
	...
	public static void assertVetoAdvice_MIB3Audi(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse vetoadvice=vetoAdvice_MIB3Audi.vetoAdvice(testname, vin, campaign, criterion);
