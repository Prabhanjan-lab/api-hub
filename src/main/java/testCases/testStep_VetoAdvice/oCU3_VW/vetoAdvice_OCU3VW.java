...
public class vetoAdvice_OCU3VW extends RegisterAndGetOAUTH{
	...
	public static void assertVetoAdvice_OCU3VW(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse vetoadvice=vetoAdvice_OCU3VW.vetoAdvice(testname, vin, campaign, criterion);
