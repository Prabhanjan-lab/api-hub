...
public class vetoAdvice_MIB3VW extends RegisterAndGetOAUTH{
	...
	public static void assertVetoAdvice_MIB3VW(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse vetoadvice=vetoAdvice_MIB3VW.vetoAdvice(testname, vin, campaign, criterion);
