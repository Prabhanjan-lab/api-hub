package testCases.testStep_VetoAdvice.oCU3_Audi;
...
public class vetoAdvice_OCU3Audi extends RegisterAndGetOAUTH{
	...
	public static void assertVetoAdvice_OCU3Audi(String testname, String vin, String campaign, String criterion) throws IOException {
		ValidatableResponse vetoadvice=vetoAdvice_OCU3Audi.vetoAdvice(testname, vin, campaign, criterion);
